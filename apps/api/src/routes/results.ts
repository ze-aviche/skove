    ...
    const pkg = await buildApplyPackage(
      {
        ...
        preferredFirstName: profileRow?.preferredFirstName,
        preferredLastName: profileRow?.preferredLastName,
        ...
        aiUsage: profileRow?.aiUsage,
        locatedBayArea: profileRow?.locatedBayArea,
        reasonForChange: profileRow?.reasonForChange,
        compensationTarget: profileRow?.compensationTarget,
