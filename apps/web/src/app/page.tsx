    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-24 pb-16 text-center">
        ...
        <p className="text-xl text-gray-500 mb-10 max-w-2xl mx-auto leading-relaxed">
          Skove finds jobs that match your resume, scores them with AI, and drafts
          tailored applications — continuously, in the background. New matches waiting when you wake up.
        </p>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { icon: '🔍', name: 'Job matching', desc: 'Watches listings matching your titles and locations. Surfaces new roles the moment they appear.' },
            { icon: '✦', name: 'AI scoring', desc: 'Scores every job against your resume so you focus on the roles worth your time.' },
            { icon: '💼', name: 'Auto-drafted applications', desc: 'Generates tailored resumes and cover letters while you sleep.' },
          ].map((agent) => (
